...
<body onload="TextWrite()">
    ...
    <main>
        ...
        <div class="container-md">
            <h1 class="textWrite">XSS Refleted.</h1>
            <div class="row">
                <div class="col-6">
                    <div class="conteudo">
                        <img class="col-md-6 float-md-end mb-3 ms-md-3" src="../img/ethicalhacking.avif" alt="hacking" style="width: 300px;">
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore quaerat alias 
                        </p>
                        <form action="#">
                            <input type="text" name="site" id="site" value="https://">
